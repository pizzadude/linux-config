...
[core]
s0_active_plugins = core;crashhandler;composite;opengl;workspacenames;decor;place;copytex;commands;session;regex;mousepoll;resize;matecompat;neg;grid;compiztoolbox;animation;move;animationaddon;thumbnail;vpswitch;imgpng;wobbly;fade;workarounds;cube;rotate;scale;expo;showmouse;ezoom;td;switcher;
